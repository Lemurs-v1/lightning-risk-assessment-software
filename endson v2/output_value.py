...
=======
import pandas as pd
df = pd.read_csv("kullanıcı_değer.csv", encoding="utf-8")

# DataFrame'deki verileri iloc kullanarak değişkenlere atayalım
Ad_C = str(df.iloc[0, 0])
Cd_C = str(df.iloc[0, 1])
rt_C = str(df.iloc[0, 2])
Ce_C = str(df.iloc[0, 3])
Adj_C = str(df.iloc[0, 4])
Cdj_C = str(df.iloc[0, 5])
Pb_C = str(df.iloc[0, 6])
Pta_C = str(df.iloc[0, 7])
Cld_C = str(df.iloc[0, 8])
Pli_C = str(df.iloc[0, 9])
Pld_C = str(df.iloc[0, 10])
Pspd_C = str(df.iloc[0, 11])
Cl_C = str(df.iloc[0, 12])
Peb_C = str(df.iloc[0, 13])
CT_C = str(df.iloc[0, 14])
ca_bolu_ct_C = str(df.iloc[0, 15])
rf_C = str(df.iloc[0, 16])
rp_C = str(df.iloc[0, 17])
Lf_C = str(df.iloc[0, 18])
Lo_C = str(df.iloc[0, 19])
Lfo2_C = str(df.iloc[0, 20])
Lfo4_C = str(df.iloc[0, 21])
KS3_C = str(df.iloc[0, 22])
Pld_2_C = str(df.iloc[0, 23])
Pld_3_C = str(df.iloc[0, 24])
Pli_2_C = str(df.iloc[0, 25])
Ng_C = str(df.iloc[0, 26])
wm1_C = float(df.iloc[0, 27])
wm2_C = float(df.iloc[0, 28])
Uw_C = float(df.iloc[0, 29])
ekranlama_C = str(df.iloc[0, 30])
metal_C = str(df.iloc[0, 31])
Ng_double_C = float(df.iloc[0, 32])
Ad_y_double_C = float(df.iloc[0, 33])
Ad_g_double_C = float(df.iloc[0, 34])
Ad_u_double_C = float(df.iloc[0, 35])
Ad_ymax = float(df.iloc[0, 48])
Adj_g_double_C = float(df.iloc[0, 36])
Adj_u_double_C = float(df.iloc[0, 37])
Adj_y = float(df.iloc[0, 49])
Adj_y_max = float(df.iloc[0, 50])
nt_C = float(df.iloc[0, 38])
nz_C = str(df.iloc[0, 39])
nz_double_C = float(df.iloc[0, 40])
tz_C = float(df.iloc[0, 41])
Ll_C = float(df.iloc[0, 42])
Hz_C = str(df.iloc[0, 43])
Ptu_C = str(df.iloc[0, 44])
tz_value = str(df.iloc[0, 45])
Ll_value = str(df.iloc[0, 46])
description = str(df.iloc[0, 47])

Rapor_yazarı = str(df.iloc[0, 51])
Müsteri = str(df.iloc[0, 52])
Obje = str(df.iloc[0, 53])
Proje_no = str(df.iloc[0, 54])
R1_value = str(df.iloc[0, 55])
R4_value = str(df.iloc[0, 56])
