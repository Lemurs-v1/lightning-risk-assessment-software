...
class LightningRiskCalculator_result():
    ...
    def R_1_belirle(self):
        soru = input("Yapıda patlama riski veya elektriksel sistemlerin arızalanması durumunda insan hayatını direkt tehlike altına alacak bir durum mevcut mu ? (evet/hayır)")
        if (soru == "evet"):
    ...
    def R_4_belirle(self):
        soru = input("Sadece hayvan kaybı riski mi mevcut ? (evet/hayır)")
        if (soru=="evet"):
