...
class MplCanvas(FigureCanvas):
    ...
    def __init__(self, parent=None, width=5, height=4, dpi=100):
        ...
        if self.R4_value =="Evet":
            ...
            self.values_4 = [self.R_B_4, self.R_C_4,self.R_M_4,self.R_V_4,self.R_W_4,self.R_Z_4]
    ...
    def grafik_1(self, constant_value_1=1e-5):
        ...
        ax.legend()
        plt.savefig('_internal\\output_pdf_1\\images\\graph_1.png')
    ...
    def grafik_2(self, constant_value_2=1e-3):
        ...
        # PNG olarak kaydetme
        plt.savefig('_internal\\output_pdf_1\\images\\graph_2.png')
    ...
    def grafik_3(self,constant_value_3=1e-4):
        ...
        # PNG olarak kaydetme
        plt.savefig('_internal\\output_pdf_1\\images\\graph_3.png')
    ...
    def grafik_4(self,constant_value_4=1e-3):
        ...
        ax.set_ylabel('Values')
        ax.legend()
        plt.savefig('_internal\\output_pdf_1\\images\\graph_4.png')
    ...
    def plot_area_ad(self, l, w, h, hp):
        ...
        self.fig.savefig("_internal\\output_pdf_1\\images\\complex_structure_ad.png")
    ...
    def plot_area_adj(self, l_a, w_a, h_a, hp_a):
        ...
        # Save the plot as a PNG file
        self.fig.savefig("_internal\\output_pdf_1\\images\\complex_structure_adj.png")
